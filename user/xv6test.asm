...
void test_1(void) {
  ...
  printf("Test 1: Simple syscall\n");
   ...
   c:	81850513          	addi	a0,a0,-2024 # 820 <malloc+0xec>
  10:	00000097          	auipc	ra,0x0
  14:	66c080e7          	jalr	1644(ra) # 67c <printf>
  int bruh = 12;
  18:	47b1                	li	a5,12
  ...
  26:	2e0080e7          	jalr	736(ra) # 302 <wait>
}
  2a:	60e2                	ld	ra,24(sp)
  2c:	6442                	ld	s0,16(sp)
...
void test_2(void) {
  ...
  3e:	7fe50513          	addi	a0,a0,2046 # 838 <malloc+0x104>
  42:	00000097          	auipc	ra,0x0
  46:	63a080e7          	jalr	1594(ra) # 67c <printf>
...
int main(int argc, char *argv[]) {
  ...
  5e:	fa6080e7          	jalr	-90(ra) # 0 <test_1>
  test_2();
  62:	00000097          	auipc	ra,0x0
  66:	fd0080e7          	jalr	-48(ra) # 32 <test_2>
...
_main()
{
  ...
  80:	fd6080e7          	jalr	-42(ra) # 52 <main>
  exit(0);
  84:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ea:	4ba50513          	addi	a0,a0,1210 # 8a0 <digits>
 3ee:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4aa:	3a2c8c93          	addi	s9,s9,930 # 848 <malloc+0x114>
 ...
 4b8:	3ecb8b93          	addi	s7,s7,1004 # 8a0 <digits>
 ...
 5de:	26698993          	addi	s3,s3,614 # 840 <malloc+0x10c>
        while(*s != 0){
 5e2:	85ee                	mv	a1,s11
